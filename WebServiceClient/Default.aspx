    ...
    <div>
        ...
        <tr>
          ...
          <td><asp:Label ID="ResultLabel" runat="server" Text=""></asp:Label></td>
            <td><asp:LinkButton ID="RegisterButton" runat="server" Text="Register" PostBackUrl="~/RegisterForm.aspx" /></td>
            <td><asp:LinkButton ID="ViewGrantsButton" runat="server" Text="View Grants" PostBackUrl="~/ViewGrants.aspx" /></td>
